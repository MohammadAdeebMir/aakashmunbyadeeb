      ...
      <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4 overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-2xl">
          ...
          <div className="space-y-3 md:space-y-4 mb-8 md:mb-10">
            <h1 className="text-2xl sm:text-3xl md:text-5xl font-bold text-foreground animate-fade-in" style={{ animationDelay: "0.3s" }}>
              Are You Ready to
            </h1>
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-secondary via-secondary to-accent animate-fade-in" style={{ animationDelay: "0.5s" }}>
              Shape the Future?
            </h2>
            <p className="text-muted-foreground text-base sm:text-lg md:text-xl mt-4 md:mt-6 animate-fade-in px-2" style={{ animationDelay: "0.7s" }}>
              Step into the world of diplomacy, debate, and global leadership.
            </p>
            <p className="text-muted-foreground/80 text-sm sm:text-base md:text-lg animate-fade-in px-2" style={{ animationDelay: "0.9s" }}>
          ...
          <button
            ...
            className="group relative px-6 sm:px-10 md:px-12 py-4 md:py-5 bg-gradient-to-r from-secondary to-accent text-secondary-foreground font-bold text-base sm:text-lg md:text-xl rounded-full hover:shadow-2xl hover:shadow-secondary/30 transition-all duration-500 transform hover:scale-105 animate-fade-in"
            style={{ animationDelay: "1.1s" }}
          >
            <span className="flex items-center gap-2 md:gap-3">
              <Sparkles className="w-5 h-5 md:w-6 md:h-6 group-hover:animate-spin" />
              <span className="whitespace-nowrap">Reveal Aakash MUN 2026</span>
              <Sparkles className="w-5 h-5 md:w-6 md:h-6 group-hover:animate-spin" />
            </span>
